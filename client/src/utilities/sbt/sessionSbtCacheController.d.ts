...
export interface SessionSbtCacheController {
  ...
  buildSbtHistorySummaryFromCounts: (
    counts?: Partial<SbtCountsPayloadInput> | null
...
export function createSessionSbtCacheController(
  host?: SessionSbtCacheHost
): SessionSbtCacheController;
