...
const buildSingleQuestionResponsePayload = ({ answer, additional, questionType, options, voiceCredits }) =>
  buildResponsePayload({
    ...
    questionPool: [{ id: 'q1', type: questionType, prompt: 'Matrix question', options, voiceCredits }],
    pileQuestions: [],
