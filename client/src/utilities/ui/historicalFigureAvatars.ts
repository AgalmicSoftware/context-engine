...
const HISTORICAL_FIGURE_LOCAL_PHOTO_BY_USERNAME = Object.freeze((historicalFigureLocalPhotoManifest || {}) as Record<string, AvatarEntry>);
const HISTORICAL_FIGURE_REMOTE_PHOTO_BY_USERNAME = Object.freeze((historicalFigurePhotoManifest || {}) as Record<string, AvatarEntry>);
...
const normalizeHistoricalFigureName = (value = ''): string => transliterate(value)
  .normalize('NFD')
  .replace(/[\u0300-\u036f]/g, '')
  .replace(/&/g, 'and')
  .replace(/[^a-zA-Z0-9]+/g, '')
