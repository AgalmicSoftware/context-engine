...
export const DICTIONARIES = Object.freeze({
  ...
  plain: Object.freeze({
    ...
    sbts: 'Groups',
    sbtsLower: 'groups',
    sbtFull: 'Membership Group',
    sbtFullLower: 'membership group',
    mint: 'Collect',
    mintLower: 'collect',
    minting: 'Collecting',
...
export const t = (key) => {
  ...
  const dictionary = DICTIONARIES[MODE] || DICTIONARIES.plain;
  return dictionary[normalizedKey] || DICTIONARIES.crypto[normalizedKey] || normalizedKey;
};
