...
export const SESSION_COLOR_SCHEME_IDS = Object.freeze(SESSION_COLOR_SCHEME_REGISTRY.map(({ id }) => id));
...
export const parseSessionColorSchemeId = (value: unknown): SessionColorSchemeId | null => {
  ...
  return Object.prototype.hasOwnProperty.call(SCHEME_BY_ID, candidate) ? (candidate as SessionColorSchemeId) : null;
};
...
export const normalizeSessionAppearance = (value: unknown): { colorSchemeId: SessionColorSchemeId } => {
