/**
 * @module contractScriptsEventScans
 * @description Stateless survey event-scan helpers extracted from contractScripts.impl.
 */
...
type ContractScriptsEventScanDeps = {
...
const createSurveyReadContext = (
  deps: ContractScriptsEventScanDeps,
  groupKeyOrCfg: unknown
) => {
...
export function createContractScriptsEventScanMethods(deps: ContractScriptsEventScanDeps) {
  return {
