...
const formatDemoCorpusDate = (entry = {}) => {
...
const formatDemoCorpusAuthors = (entry = {}) => {
...
const buildDemoCorpusTitle = (entry = {}, corpusLabel = '') => {
...
const buildDemoCorpusSummary = (entry = {}, title = '') => {
...
export const buildDemoCorpusRecords = (demoCorpuses = []) => {
