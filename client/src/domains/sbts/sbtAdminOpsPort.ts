...
export const bindSbtAdminOpsPort = ({ chainGateway: readChainGateway }: BindSbtAdminOpsPortArgs): SbtAdminOpsPort => ({
  ...
  burnToken: (providerName, sbtAddress, tokenId) => readChainGateway().burnToken(providerName, sbtAddress, tokenId),
