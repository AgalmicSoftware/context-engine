...
import {
  ...
  USE_LOCAL_WORKER_BUNDLE_FALLBACK,
  WORKER_BUNDLE_URL,
...
export const ENABLE_RPC_DEBUG_LOGGING = readPublicBoolEnv(
  'REACT_APP_ENABLE_RPC_DEBUG_LOGGING',
  false
);
export const ENABLE_RPC_DEBUG_STATS = readPublicBoolEnv(
  'REACT_APP_ENABLE_RPC_DEBUG_STATS',
  false
);
export const ENABLE_RPC_DEBUG_TRACE = readPublicBoolEnv(
  'REACT_APP_ENABLE_RPC_DEBUG_TRACE',
  false
);
export const CE_RPC_VERBOSE_ERRORS = readPublicBoolEnv(
  'REACT_APP_CE_RPC_VERBOSE_ERRORS',
  false
);
export const CE_RPC_LOG_PROVIDER_SUCCESS = readPublicBoolEnv(
  'REACT_APP_CE_RPC_LOG_PROVIDER_SUCCESS',
  false
);
export const DISABLE_SBT_INSTANCE_LISTENERS = readPublicBoolEnv(
  'REACT_APP_DISABLE_SBT_INSTANCE_LISTENERS',
  false
);
export const MAX_SBT_INSTANCE_LISTENERS = readPublicIntEnv(
  'REACT_APP_MAX_SBT_INSTANCE_LISTENERS',
  25
);
// Per-instance SBT listeners are enabled only for these group slugs (use "general" for the default group).
export const SBT_INSTANCE_LISTENER_GROUPS = readPublicListEnv(
  'REACT_APP_SBT_INSTANCE_LISTENER_GROUPS',
  ['general']
);
// When false, skip mint/burn history scans during SBT cache initialization.
export const ENABLE_SBT_HISTORY_SCAN = readPublicBoolEnv(
  'REACT_APP_ENABLE_SBT_HISTORY_SCAN',
  false
);
// Toggle the Conviction/Importance slider swap UI (SurveyTool)
export const ENABLE_IMPORTANCE_SLIDER_TOGGLE = readPublicBoolEnv(
  'REACT_APP_ENABLE_IMPORTANCE_SLIDER_TOGGLE',
  true
);
...
export const PREFER_PATH_RPC = readPublicBoolEnv(
  'REACT_APP_PREFER_PATH_RPC',
  true
);
...
export const CE_USE_INFURA_RPC = readPublicBoolEnv(
...
export const CE_RPC_PROVIDER_MODE = readPublicEnv(
  'REACT_APP_CE_RPC_PROVIDER_MODE',
  'fallback'
);
export const TERMINOLOGY_MODE = readPublicEnv(
  'REACT_APP_TERMINOLOGY_MODE',
  'plain'
);
// Bounded concurrency for getLogs split scans (lower is safer against RPC storms).
export const CE_GETLOGS_MAX_CONCURRENCY = readPublicIntEnv(
  'REACT_APP_CE_GETLOGS_MAX_CONCURRENCY',
  1
);
// Retry cap for eth_getLogs requests (separate from the generic retry wrapper).
export const CE_GETLOGS_MAX_RETRIES = readPublicIntEnv(
  'REACT_APP_CE_GETLOGS_MAX_RETRIES',
  2
);
...
export const CE_PROFILE_SCAN_SBT_BURST_SIZE = readPublicIntEnv(
  'REACT_APP_CE_PROFILE_SCAN_SBT_BURST_SIZE',
  4
);
// Per-slug timeout for SBT fetch steps during profile deep scans (milliseconds).
export const CE_PROFILE_SCAN_SBT_TIMEOUT_MS = readPublicIntEnv(
  'REACT_APP_CE_PROFILE_SCAN_SBT_TIMEOUT_MS',
  30000
);
...
export const CE_PROFILE_SCAN_COLD_DIAG = readPublicBoolEnv(
  'REACT_APP_CE_PROFILE_SCAN_COLD_DIAG',
  false
);
...
export const CE_SBT_INSTANCE_LISTENERS_MODE = readPublicEnv(
  'REACT_APP_CE_SBT_INSTANCE_LISTENERS_MODE',
  'auto'
); // auto|on|off
export const CE_SBT_FULL_SCAN_POLICY = readPublicEnv(
  'REACT_APP_CE_SBT_FULL_SCAN_POLICY',
  'auto'
); // auto|sbts|manual
...
export const DEFAULT_SESSION_SLUG = readPublicEnv(
  'REACT_APP_DEFAULT_SESSION_SLUG',
  ''
);
// URL/on-chain alias used when the slug is empty.
export const DEFAULT_SESSION_SLUG_ALIAS = readPublicEnv(
  'REACT_APP_DEFAULT_SESSION_SLUG_ALIAS',
  'general'
);
export const SERVER = readPublicEnv(
  'REACT_APP_SERVER',
  'http://localhost:5000'
);

export const ARWEAVE_ACTIVE = readPublicBoolEnv(
  'REACT_APP_ARWEAVE_ACTIVE',
  true
);
...
export const ARWEAVE_GATEWAY_URL = readPublicEnv(
...
export const CE_ARWEAVE_AR_IO_URL = readPublicEnv(
...
export const DEFAULT_CHAIN_ID = 11155420 && readPublicIntEnv(
...
export const TESTNET_AUTO_SEND_THRESHOLD_ETH = readPublicEnv(
...
export const ETH_FAUCET_LINK = readPublicEnv(
  'REACT_APP_ETH_FAUCET_LINK',
  'http://127.0.0.1:8545'
);
...
export const CLOUDFLARE_CORS_WORKER_URL = readPublicEnv(
...
import { initializeRuntimeConfig } from '../utilities/session/runtimeConfig.js';
