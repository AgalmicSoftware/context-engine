  ...
  render() {
    ...
    return (
      <div className={`${styles.simUserPage} ${minimized ? styles.minimized : ''}`}>
                    ...
                    <div className={styles.positionList}>
                      {atlasPositions.map((pos) => {
                        ...
                        return (
                          ...
                          >
                            <span
                              className={`${styles.voteIndicator} ${pos.vote > 0 ? styles.positive : styles.negative}`}
                        ...
                        {opponents.map((o, i) => {
                          ...
                          return (
                            <a key={i} href={buildPublicRoute(`/su/${o.username}`)} className={styles.relatedFigure}>
                              ...
                              <span className={`${styles.relatedScore} ${styles.disagree}`}>{o.disagree}</span>
                            </a>
                          );
                        })}
                      </div>
        ...
        <Modal isOpen={this.state.showFullProfileModal} toggle={() => this.setState({ showFullProfileModal: false })} size="lg" className={styles.modalContent}>
