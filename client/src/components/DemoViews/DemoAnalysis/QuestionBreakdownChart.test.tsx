...
const flatResponses = [
  ...
  { questionId: 'q1', responseText: 'Unsure', segmentKey: 'Era:Modern', rate: 0.25, totalVotes: 4, participantCount: 2 },
  ...
  it('keeps the response count when the first ordered option has no row', () => {
    render(
      <QuestionBreakdownChart
        question={question}
        flatResponses={[
          { questionId: 'q1', responseText: 'Unsure', segmentKey: 'All', rate: 0.67, totalVotes: 3, participantCount: 3 },
          { questionId: 'q1', responseText: 'Disagree', segmentKey: 'All', rate: 0.33, totalVotes: 3, participantCount: 3 },
        ]}
        comparisonGroups={[]}
      />
    );
