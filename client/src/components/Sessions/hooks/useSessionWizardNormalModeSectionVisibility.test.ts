...
const renderVisibility = ({
  ...
  renderHook(() => useSessionWizardNormalModeSectionVisibility({
    isNormalMode,
...
const applyUpdater = (
  setCollapsedSections: jest.Mock,
  prev: CollapsedSectionsState
...
describe('useSessionWizardNormalModeSectionVisibility', () => {
  ...
  it('preserves the first open visible section in normal mode', () => {
    ...
    expect(applyUpdater(setCollapsedSections, {
      metadata: true,
      encryption: true,
      worker: false,
      publish: true,
