...
describe('postsContent', () => {
  ...
  it('builds post asset URLs under PUBLIC_URL', () => {
    ...
    expect(buildPostAssetUrl('attachments/image.png', 'agent-village-wrapped')).toBe('/ce/posts/agent-village-wrapped/attachments/image.png');
  ...
  it('derives post-local attachment bases from nested post files', () => {
    expect(getPostAssetBasePath('agent-village-wrapped/agent-village-wrapped.md'))
      .toBe('agent-village-wrapped');
