...
it('shows incomplete results only for the matching Worker and session', () => {
  ...
  const { rerender } = render(
    <WorkerResponseHydrationNotice sessionConfig={sessionConfig} sessionSlug="example" partialRuns={partialRuns} />,
  );
  ...
  rerender(
    <WorkerResponseHydrationNotice
      sessionConfig={{ ...sessionConfig, corsWorkerUrl: 'https://replacement.example' }}
      sessionSlug="example"
