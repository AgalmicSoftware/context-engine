...
import { ensureQuestionArweaveCacheBranches, mergeQuestionArweaveCacheBranches } from '../../domains/surveys/questionArweaveCacheBranches.js';
import { normalizeSessionSlug } from '../../domains/sessions/sessionConfig.js';
import { createInitialProfileScanReport, createProfileScanFanoutPlan, resolveProfileScanAttemptedCoverageSlugs } from '../../utilities/session/profileScanReportHelpers.js';
  ...
  targetAddress: unknown
    ...
    const run = (async () => {
      ...
      const unresolvedListScopeChainIds = (
        ...
        totalSkippedScan &&
        report.attemptedSlugs.length > 0 &&
        report.attemptedSlugs.every((slug: string) => (
