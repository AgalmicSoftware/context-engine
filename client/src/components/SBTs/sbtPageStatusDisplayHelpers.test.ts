...
describe('sbtPageHelpers status and display helpers', () => {
  it('detects usable and active SBT scan progress', () => {
    ...
    expect(buildSbtPageAdminFallbackPatch({
    ...
    expect(resolveSbtPageAdminCreatorAddresses({
    ...
    expect(resolveSbtPageBurnStatusButtonState({
      burningStatus: 'idle',
    })).toEqual({
      disabled: false,
      isFailure: false,
    ...
    expect(resolveSbtPagePasswordGenerationButtonState({
    ...
    expect(resolveSbtPageMiniOpenMintButtonState({
      mintingStatus: 'idle',
    })).toEqual({
      disabled: false,
      isFailure: false,
    ...
    expect(resolveSbtPageMiniBurnButtonState({
      burningStatus: 'pending',
    })).toEqual({
      disabled: true,
      isPending: true,
    ...
    expect(resolveSbtPageRelevantInfoDisplayState({
