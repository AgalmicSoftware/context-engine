...
const resetSBTsListListModeTestState = () => {
  jest.clearAllMocks();
...
const restoreSBTsListSyncBarStep = () => {
...
export {
  ...
  ORIGINAL_SBT_SYNC_BAR_RESEARCH_BLOCK_STEP,
  setupGroupMocks,
  SESSION_SELECTOR_PANEL_TEST_ID,
  SESSION_SELECTOR_TOGGLE_TEST_ID,
  openSessionSelector,
