...
- `header.jpg` — compressed banner image used by the manifest; `header.png` remains the full-resolution source.
...
- [x] `header.jpg` — compressed banner image rendered by the post
- [x] `header.png` — full-resolution source banner
