...
Use plain concrete language. Do not invent undefined acronyms, code words, shorthand, or jargon. Never write phrases like "triple-v", "zero-knowledge negotiation", "proof over promises", or similar unless the exact phrase appears in the evidence below. Prefer a sentence a normal viewer can understand immediately, like "You prefer agents that ask first, explain their reasoning, and protect private context."
