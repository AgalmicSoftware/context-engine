...
Hero text fit rule: the memeable sentence must be one complete sentence under 14 words and under 90 characters. Keep it to at most 3 short lines with at least 10% inner padding around the text. Never hyphenate, crop, truncate, or trail off the hero sentence mid-word. If the sentence would not fit, rewrite it shorter and more concrete.
