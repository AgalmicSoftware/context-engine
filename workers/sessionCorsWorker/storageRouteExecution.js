...
const evaluateAccessCondition = async ({ condition, config, requesterAddress, authScopes, deps }) => {
  ...
  if (kind === 'worker_group') {
    return { ok: false, reason: 'reserved_condition_kind', condition: { kind: 'worker_group' } };
  }
