...
const ethersUtils = (() => {
  ...
  return {
    isAddress: utils.isAddress || ethers.isAddress,
    getAddress: utils.getAddress || ethers.getAddress,
    keccak256: utils.keccak256 || ethers.keccak256,
    toUtf8Bytes: utils.toUtf8Bytes || ethers.toUtf8Bytes,
    hexlify: utils.hexlify || ethers.hexlify,
    arrayify: utils.arrayify || ethers.getBytes,
  };
})();
