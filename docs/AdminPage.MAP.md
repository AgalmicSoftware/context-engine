...
| `client/src/domains/storage/adminArweavePorts.ts` | `arweave/arweaveScripts.js`, `arweave/arweaveUrls.js` | Arweave wallet balance reads, Winston formatting, admin upload probe, gateway URL building, and registry metadata URL normalization. |
