...
- `client/src/components/SurveyTool/CreateSurvey.jsx`
...
Generated by `CreateSurvey.createSurvey` and uploaded to Arweave before
...
```json
{
  ...
  "creator": "0xF39Fd6e51aad88F6F4ce6aB8827279cffFb92266",
  "documentURLs": ["https://example.com/whitepaper"],
...
- Question tag encryption is controlled by `encryption.targets.questionTags` and defaults to enabled when prompt encryption is enabled in CreateSurvey.
