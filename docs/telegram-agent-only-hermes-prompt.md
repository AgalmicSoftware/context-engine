...
should verify v40 before doing work, and should stop before fetching statements
...
"Your Agent Village Wrapped is ready. To inspect or change your agent's responses, open [Context Engine Telegram Bot](https://t.me/contextengineer_bot?start=agent_onboarding__agent-village-2026) and tap Open Mini App. Want the optional political compass meme too?"
