...
| Emails | 3,159 | Dominated by git author metadata and public contact/security emails. Public emails are allowed; placeholder examples such as `[redacted-email]` and `[redacted-email]` were also present. |
