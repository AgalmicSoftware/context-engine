...
- `docs/session-results-html-report-prd.md`: PRD for exporting a point-in-time, navigable static HTML session results report with report, argument map, risk matrix, atlas nodes, and embedded snapshot JSON.
