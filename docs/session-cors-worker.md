...
`client/src/utilities/session/sessionAuthorityMatrix.js` and partially adopted by
`client/src/utilities/session/canonicalSessionContext.js`; full gate and secret
