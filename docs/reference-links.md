...
- **Relevance:** Direct reference implementation for the Polis math that Context Engine's `polisMath.js` implements. Useful for validating our clustering, comparing algorithms, or porting improved techniques.
