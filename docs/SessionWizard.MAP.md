...
- Start in `sessionWizardPublishController.ts` for publish step dispatch, metadata-upload dispatch, register-step request planning, register-step tx/status, and completion sequencing that calls injected side-effect ports/callbacks.
