...
- Hook inventory: **24 KPI `useState(` calls** (**37 generic-aware `useState` calls**), **32 `useEffect` calls**, **29 `useMemo` calls**, **13 `useCallback` calls**
