...
- Hook inventory: **38 KPI `useState(` calls** (**55 generic-aware `useState` calls**), **32 `useEffect` calls**, **29 `useMemo` calls**, **13 `useCallback` calls**
