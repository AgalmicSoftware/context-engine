...
- Hook inventory: **18 KPI `useState(` calls** (**30 generic-aware `useState` calls**), **18 `useEffect` calls**, **29 `useMemo` calls**, **12 `useCallback` calls**
