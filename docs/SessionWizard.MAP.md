...
- Hook inventory: **19 KPI `useState(` calls** (**31 generic-aware `useState` calls**), **29 `useEffect` calls**, **29 `useMemo` calls**, **12 `useCallback` calls**
