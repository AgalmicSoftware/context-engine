...
- Hook inventory: **46 KPI `useState(` calls** (**63 generic-aware `useState` calls**), **41 `useEffect` calls**, **29 `useMemo` calls**, **13 `useCallback` calls**
