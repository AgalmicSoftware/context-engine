...
- Current length: **4,658 lines**
- Shell file: `client/src/components/Sessions/SessionWizardShell.tsx` (**406 lines**)
- Intro/status rail file: `client/src/components/Sessions/SessionWizardIntroStatusRail.tsx` (**63 lines**)
- Publish summary file: `client/src/components/Sessions/SessionPublishSummary.tsx` (**224 lines**)
...
| Final shell handoff | 4494-4658 | Derives and forwards the full `/new` surface state/handlers into the passive shell while retaining parent-owned side effects | `SessionWizardShell`, `export default SessionWizard` |
