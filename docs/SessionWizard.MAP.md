...
- Hook inventory: **21 KPI `useState(` calls** (**33 generic-aware `useState` calls**), **29 `useEffect` calls**, **29 `useMemo` calls**, **13 `useCallback` calls**
