...
- Hook inventory: **50 KPI `useState(` calls** (**69 generic-aware `useState` calls**), **43 `useEffect` calls**, **29 `useMemo` calls**, **13 `useCallback` calls**
