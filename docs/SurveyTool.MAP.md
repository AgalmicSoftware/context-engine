...
- Current lengths:
  ...
  - `SurveyResultsPanels.tsx`: **158 lines**
...
| `SurveyResultsPanels.tsx` | Results panel presentation helpers | Renders sync-status progress panel directly from `SurveyResultsSyncStatusDisplayPlan` while leaving display-plan construction in controller helpers and handlers/state in `SurveyResults` |
