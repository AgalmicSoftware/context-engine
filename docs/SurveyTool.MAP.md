...
- Current lengths:
  ...
  - `SurveyQuestions.tsx`: **8,470 lines**
  ...
  - `SurveyResultsPanels.tsx`: **196 lines**
...
SurveyTool.tsx  [top-level wrapper]
  -> SurveySelector.tsx  [survey/questions selector + filter + results]
     ...
     -> SurveyQuestions.tsx  [shared full response runtime]
        ...
        -> surveyToolSingleQuestionCacheBootstrapController.ts  [single-question source-restore, cache-bootstrap flow, and seeded hydration planning]
