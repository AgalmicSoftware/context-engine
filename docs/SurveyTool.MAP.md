...
SurveyTool.tsx  [top-level wrapper]
  -> SurveySelector.tsx  [survey/questions selector + filter + results]
     ...
     -> SurveyResults.tsx  [survey/question results runtime and execution owner]
        ...
        -> surveyResultsExportDisplayHelpers.ts  [HTML report compatibility re-exports]
...
| `surveyResultsExportDisplayHelpers.ts` | HTML report compatibility re-exports | Re-exports the split HTML report selection, readiness, state-patch, modal descriptor, and download-attempt helpers for older local import paths while owning no runtime decisions |
