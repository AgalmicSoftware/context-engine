...
- Current lengths:
  ...
  - `SurveyQuestions.tsx`: **8,624 lines**
  - `surveyQuestionsState.ts`: **55 lines**
  - `surveyQuestionsTestHarness.tsx`: **138 lines**
  ...
  - `SurveyResults.tsx`: **5,031 lines**
  - `surveyResultsState.ts`: **152 lines**
  - `surveyResultsTestHarness.tsx`: **111 lines**
  ...
  - `SurveyResultsDisplayPanels.tsx`: **188 lines**
  - `SurveyResultsFilterSummary.tsx`: **47 lines**
  - `SurveyResultsQuestionListPanel.tsx`: **49 lines**
  ...
  - `SurveyResultsFilterExportControls.tsx`: **208 lines**
  - `SurveyResultsHtmlReportExportModal.tsx`: **284 lines**
  - `SurveyResultsHtmlReportActionControls.tsx`: **50 lines**
  - `SurveyResultsHtmlReportAnalysisControls.tsx`: **82 lines**
  ...
  - `surveyResultsExportDisplayHelpers.ts`: **778 lines**
  ...
  - `SurveyResultsIndividualResponseBody.tsx`: **213 lines**
  ...
  - `surveyResultsSyncStatusController.ts`: **173 lines**
  - `surveyResultsBlockNumbers.ts`: **25 lines**
  ...
  - `surveyResultsQuestionNetworkReadController.ts`: **371 lines**
  ...
  - `surveyResultsBookmarkCacheReadPorts.ts`: **44 lines**
...
- Pile strategy typing and boundary cleanup after the higher-priority web3 typing milestone
...
The inheritance boundary has been replaced. `SurveyQuestions.tsx` is the shared function runtime, and `SurveyPileViewMode.tsx` renders that runtime with a pile strategy instead of inheriting from it. The strategy owns pile-specific initial state, lifecycle hooks, render flow, and pile-only actions; the shared runtime still owns response/decrypt/submit/cache semantics.
...
1. Type `SurveyPileViewMode.tsx` boundary-first after the higher-priority web3 typing milestone.
2. Target a remaining shared decrypt/source-restore wrapper or small engine-bag assembly reduction.
3. Keep Lit/decrypt, submit, cache, route, worker, wallet, and state application ownership in the shared runtime until a smaller tested controller can own a pure decision only.
