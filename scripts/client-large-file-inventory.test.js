...
const LARGE_CLIENT_FILE_BASELINE = Object.freeze({
  'client/src/components/SurveyTool/SurveyQuestions.tsx': 9422,
  'client/src/components/MainSite/MainSite.tsx': 6565,
  'client/src/components/SurveyTool/SurveyResults.tsx': 5574,
  'client/src/utilities/web3/contractScripts.impl.ts': 5441,
  'client/src/components/SBTs/SBTPage.tsx': 5365,
  ...
  'client/src/components/PolisReport/PolisReport.tsx': 3730,
  'client/src/components/SurveyTool/QuestionFilter.tsx': 3654,
  'client/src/components/Admin/AdminPage.tsx': 3525,
  'client/src/components/SBTs/SBTsList.tsx': 3420,
  'client/src/components/DebateMap/DebateMap.tsx': 3291,
  'client/src/components/Account/LoginAndSettingsModal.tsx': 3001,
  'client/src/components/UserPage/CompareAddresses.tsx': 2900,
  'client/src/components/OnePageSession/OnePageSession.tsx': 2868,
  'client/src/components/SurveyTool/surveyToolHydrationFlow.ts': 2840,
  'client/src/components/SurveyTool/SurveyPileViewMode.tsx': 2788,
  'client/src/utilities/arweave/arweaveScripts.js': 2652,
  'client/src/utilities/web3/sessionRegistry.ts': 2279,
  'client/src/components/SBTs/SBTSelector.tsx': 2267,
  'client/src/components/SurveyTool/SurveyGenerator/SurveyGenerator.tsx': 2225,
  'client/src/utilities/survey/sessionQuestionCacheController.ts': 2101,
  'client/src/utilities/ai/aiScripts.js': 2091,
  'client/src/components/CommunityTab/CommunityTab.tsx': 2083,
  'client/src/components/SurveyTool/SurveySelector.tsx': 2063,
  'client/src/utilities/sbt/sessionSbtCacheController.js': 2047,
  'client/src/utilities/crypto/cryptography.ts': 2043,
  'client/src/utilities/crypto/litProtocol.ts': 1909,
  'client/src/components/SBTs/sbtSelectorHelpers.ts': 1768,
  'client/src/components/SurveyTool/surveyToolDecryptFlow.js': 1663,
  'client/src/components/UserPage/userPageHelpers.ts': 1612,
  ...
  'client/src/components/SBTs/sbtFilterHelpers.ts': 1532,
  'client/src/components/TagPage/TagPage.tsx': 1528,
  'client/src/components/SBTs/sbtListHelpers.ts': 1499,
  'client/src/components/SBTs/sbtPageHelpers.ts': 1478,
  'client/src/utilities/survey/sessionResponseHydrationController.ts': 1473,
  'client/src/components/SBTs/SBTFilter.tsx': 1450,
  ...
  'client/src/components/SurveyTool/surveyToolDraftState.ts': 1248,
  'client/src/components/MainContent/RiskMatrix.tsx': 1234,
  'client/src/utilities/worker/workerAuth.js': 1234,
  'client/src/utilities/session/sessionProfileScanController.ts': 1227,
  'client/src/utilities/web3/portoFunctions.ts': 1200,
  ...
  'client/src/utilities/web3/contractProfile.ts': 1103,
  'client/src/utilities/web3/rpcProviders.ts': 1068,
